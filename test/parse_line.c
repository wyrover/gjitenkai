//gcc -g parse_line.c ../src/worddic/dicentry.c ../src/worddic/gloss.c ./print_entry.c $(pkg-config --cflags --libs gtk+-3.0) -I../src/worddic/ -o parse_line
//gcc -g parse_line.c ../src/worddic/dicentry.c ../src/worddic/gloss.c  ./print_entry.c $(pkg-config --cflags --libs gtk+-3.0) -I../src/worddic/ -DMINGW -o parse_line.exe
#include <gtk/gtk.h>
