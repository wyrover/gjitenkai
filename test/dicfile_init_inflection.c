//gcc -g dicfile_init_inflection.c ../src/common/dicutil.c ../src/worddic/inflection.c ../src/worddic/worddic_dicfile.c ../src/worddic/dicentry.c ../src/worddic/gloss.c $(pkg-config --cflags --libs gtk+-3.0) -I../src/worddic/ -o dicfile_init_inflection
